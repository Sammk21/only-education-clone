...
const StudyIn = async () => {
  const studyINdiaQuery =
    "/api/study-india?populate[faq][populate][header][populate]=true&populate[faq][populate][faq][populate]=true&populate[eligibilityTable][populate][eligibilityTable][populate]=true&populate[eligibilityTable][populate][header][populate]=true&populate[explore][populate][header][populate]=true&populate[explore][populate][list][populate]=true";
  const data = await getStrapiData(studyINdiaQuery);
  const { faq, eligibilityTable, explore } = data;
  return (
