...
const StudyUniversity = async ({ params }: { params: { slug: string } }) => {
  ...
  const { cta, overviewTabs, syllabus_subject, jobs, title, id, faq } = entry;
    ...
    <div className="">
      <div className="px-2 my-8 items-center sm:px-16  ">
        <h2 className="text-2xl font-bold dark:text-light text-dark ">
          {title} : Course Details, Admission, Fees, Eligibility, Syllabus, Jobs & Salary
        </h2>
      </div>
  ...
  <div className="lg:col-span-8 col-span-12">
    <TabsContent className="bg-orange-50 mt-0 rounded-t-xl flex-col lg:grid  lg:px-10 sm:px-6 px-px xl:px-16 mx-auto" value="overview">
      <div className="mt-3 px-1 sm:px-3 lg:col-span-8 col-span-12">
        {overviewTabs?.latestupdates && <GlobalUniversitiesTabs data={overviewTabs.latestupdates} />}
        {overviewTabs?.overview && <GlobalUniversitiesTabs data={overviewTabs.overview} />}
    ...
    <TabsContent className="bg-orange-50 mt-0 rounded-t-xl  flex-col lg:grid lg:px-10 sm:px-6 px-px xl:px-16 mx-auto" value="syllabus">
      <div className="mt-3 px-1 sm:px-3 col-span-8">
        {syllabus_subject?.subjects && <GlobalUniversitiesTabs data={syllabus_subject.subjects} />}
    ...
    <TabsContent className="bg-orange-50 mt-0 rounded-t-xl  flex-col lg:grid lg:px-10 sm:px-6 px-px xl:px-16 mx-auto" value="jobs">
      <div className="mt-3 px-1 sm:px-3 col-span-8">
        {jobs?.jobOpportunities && <GlobalUniversitiesTabs data={jobs.jobOpportunities} />}
    ...
    {/* <TabsContent className="bg-orange-50 mt-0 rounded-t-xl  flex-col lg:grid lg:px-10 sm:px-6 px-px xl:px-16 mx-auto" value="exams">
      <div className="mt-3 px-1 sm:px-3 col-span-8">
        {jobs?.jobOpportunities && <GlobalUniversitiesTabs data={jobs.jobOpportunities} />}
