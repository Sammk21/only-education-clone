          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div className="col-span-full">
                ...
                <div className="mt-2 flex items-center gap-x-3 text-black">
                  <BsPerson
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-xs">
                      Change your profile picture Size should be less than
                      500kb, only PNG/JPEG supported
                    </p>
                    <button
                      type="button"
                      className="rounded-md max-w-24 my-2 bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                    >
                      Change
                    </button>
                  </div>
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-2">
                  <input
                    ...
                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1  placeholder:text-gray-400 focus:ring-2  sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
              <div className="sm:col-span-2">
