...
const AdmissionProcessFlow = () => {
  return (
    <div className="my-12">
      <h2 className="my-8 text-4xl font font-medium text-center text-dark dark:text-light">
        Admission process
      </h2>
      <div className="flex w-full justify-center">
        <div className="grid grid-cols-1  gap-x-28 items-center justify-center xl:grid-cols-3  gap-y-16 relative xl:gap-x-36  font-medium">
