...
const TermsCondition = () => {
  return (
    <section className="py-12 prose lg:max-w-[85%] lg:m-auto px-6 lg:px-0">
      ...
      <h2>License</h2>
      <p className="text-accent">
        Unless otherwise stated, Affinity Education Pvt. Ltd and/or its
        licensors own the intellectual property rights for all material on
        onlyeducation.in. All intellectual property rights are reserved. You may
        access this from onlyeducation.in for your own personal use subjected to
      ...
      <ol className="text-accent">
        <li> Republish material from onlyeducation.in</li>
        <li>Sell, rent or sub-license material from onlyeducation.in</li>
        <li> Reproduce, duplicate or copy material from onlyeducation.in</li>
        <li>Redistribute content from onlyeducation.in</li>
      </ol>
      <p className="text-accent">
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Affinity Education Pvt. Ltd does not filter, edit, publish or review
        Comments prior to their presence on the website. Comments do not reflect
        the views and opinions of Affinity Education Pvt. Ltd,its agents and/or
        ...
        laws, Affinity Education Pvt. Ltd shall not be liable for the Comments
