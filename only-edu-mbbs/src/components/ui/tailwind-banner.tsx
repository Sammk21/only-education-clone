    ...
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      ...
      >
        <div
          ...
          className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-[#ff9f45] to-[#26252d] opacity-30"
        />
      </div>
      <div
        aria-hidden="true"
      ...
      >
        <div
          ...
          className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-[#e0af80] to-[#4b8bebcc] opacity-30"
        />
      </div>
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        ...
        <PhoneInputForm existingPhone={existingPhone} userId={userId} />
      </div>
